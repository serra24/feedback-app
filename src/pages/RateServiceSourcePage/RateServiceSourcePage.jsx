...
const RateServiceSourcePage = () => {
  ...
  const {
    ...
    bookingNumber: prevBookingNumber = "",
  } = location.state || {};
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      navigate("/evaluation/evaluation-form", {
        state: {
          ...values,
          sourceId,
          branchId,
    ...
    >
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1 }}>
            <InputField
              label={t.Complaint.bookingNumber.label || "Booking Number"} // Fallback if translation missing
              ...
              placeholder={
                t.Complaint.bookingNumber.placeholder || "Enter booking number"
              }
...
export default RateServiceSourcePage;
